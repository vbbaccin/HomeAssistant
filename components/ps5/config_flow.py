"""Config Flow for PlayStation 5."""
from collections import OrderedDict

from psremoteplay.errors import CredentialTimeout
from psremoteplay.helpers import Helper
...
class PlayStation5FlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a PlayStation 5 config flow."""
    ...
    async def async_step_creds(self, user_input=None):
        """Return PS5 credentials from 2nd Screen App."""
        errors = {}
